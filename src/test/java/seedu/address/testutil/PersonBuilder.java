...
public class PersonBuilder {
    ...
    /**
     * Removes the {@code Instagram} of the {@code Person} that we are building.
     */
    public PersonBuilder withoutInstagram() {
        this.instagram = null;
        return this;
    }

    public Person build() {
        return new Person(name, phone, email, instagram, address, tags);
    }
